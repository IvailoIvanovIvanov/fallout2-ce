...
#define GAME_CONFIG_UPSCALER_FILTER_EDGE_KEY "filter_edge"
#define GAME_CONFIG_UPSCALER_FILTER_COLOR_KEY "filter_color"
#define GAME_CONFIG_UPSCALER_FILTER_SATURATION_KEY "filter_saturation"
#define GAME_CONFIG_UPSCALER_FILTER_CONTRAST_KEY "filter_contrast"
